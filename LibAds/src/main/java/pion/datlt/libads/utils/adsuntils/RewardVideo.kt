...
fun Fragment.showAdsRewardVideo(
    configName: String,
    ...
    dialogView: View? = LayoutInflater.from(context).inflate(R.layout.dialog_reward_video, null),
    ...
    fun showDialog() {
        ...
        //set event
        dialogView.findViewById<View>(R.id.btnWatchAds)?.let {
